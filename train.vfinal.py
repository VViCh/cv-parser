...
log_file = "training_log.vfinal.txt"
logging.basicConfig(
    level=logging.INFO,
...
def has_improved(current_f1, best_f1, current_loss, best_loss):
    # Improvement logic:
    # 1) F1 improves by min delta
    # 2) If F1 is essentially tied, accept a meaningful loss reduction
...
with open("training_results.vfinal.json", 'w') as f:
    json.dump(results, f, indent=4)

logger.info("\nDetailed results saved to training_results.vfinal.json")
